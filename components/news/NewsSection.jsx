...
export default function NewsSection({newsList}) {
  return (
    <LinkIndicator href="/news" className="flex flex-col justify-center items-center py-20">
      <div className="flex flex-col items-center max-w-full xl:w-[1200px] xl:px-0 px-3">
        <div className="flex flex-wrap gap-10 justify-between items-center self-stretch w-full max-md:max-w-full">
          ...
          <div className="flex gap-2 justify-center items-center self-stretch px-6 py-3.5 my-auto text-base font-semibold tracking-tight text-blue-500 rounded-[10px] border-2 border-blue-500 border-solid min-h-[46px] max-md:px-5" tabIndex="0">
