...
function OurClients() {
  ...
  return (
    <div className="container expertise-section mx-auto our-clients-block mt-[136px]">
      ...
      >
        <SwiperSlide className="swiper-our-clients-item">
          <div className="client-answer">
            &quot;The marketing strategies provided by this team are
            unparalleled. Our brand witnessed a significant boost in visibility
            and engagement. Truly exceptional work!&quot;
          </div>
          <div className="client-information">
            ...
            <div className="client-detail">
              <div className="client-name">Michael Rodriguez</div>
              <div className="client-position">CEO, Tech Innovators Inc.</div>
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide className="swiper-our-clients-item">
          <div className="client-answer">
            &quot;Working with them was a game-changer for our business. Their
            innovative campaigns and strategic insights brought us measurable
        ...
        <SwiperSlide className="swiper-our-clients-item">
          <div className="client-answer">
            &quot;Impressed by the commitment to excellence and attention to
            detail. The team not only understands marketing but also takes the
            time to understand our unique needs. A reliable partner for
            success.&quot;
          </div>
          <div className="client-information">
            <div className="client-avatar">
            ...
            <div className="client-detail">
              <div className="client-name">Emily Chen</div>
              <div className="client-position">
                Director of Sales, Global Ventures Ltd.
              </div>
            </div>
          </div>
        </SwiperSlide>
      ...
      <div className="our-clients-pagination text-center">
